    ...
    <Router>
      <Switch>
        ...
        <Route
          exact
          path="/ward-signin"
          component={props => <WardSignIn {...props} />}
        />
        <Route
          exact
          path="/ward-activation"
          component={props => <WardActivation {...props} />}
        />
        <Route
          exact
          path="/signup"
        ...
        <Route
          ...
          path="/ward-dashboard"
          component={props => (
            <WardDashBoard {...props} infusionData={infusionData} />
          )}
        />
        <Route
          exact
          path="/ward-operation"
          component={props => <WardOperation {...props} />}
        />
        <Route
          exact
          path="/ward-device"
          component={props => <WardDevice {...props} />}
        />
        <Route
          exact
          path="/ward-nurse"
          component={props => <WardNurse {...props} />}
        />
        <Route exact path="/email-confirmation" component={EmailConfirmation} />
        <Route
          exact
          path="/operation-detail/:operationId"
          component={props => <OperationDetail {...props} />}
        />
        <Route
          exact
          path="/connected-inuse"
          component={props => <ConnectedInuse {...props} />}
        />
        <Route
          exact
          path="/nurse-detail"
          component={props => <NurseDetail {...props} />}
        />
        <Route
          exact
          path="/ward-setting"
          component={props => <WardAccountSetting {...props} />}
        />
        <Route
          exact
          path="/management-signin"
          component={props => <ManagementSignIn {...props} />}
        />
        <Route
          exact
          path="/management-dashboard"
          component={props => <ManagementDashboard {...props} />}
        />
        <Route
          exact
          path="/management-ward"
          component={props => <ManagementWard {...props} />}
        />
        <Route
          exact
          path="/management-device"
          component={props => <ManagementDevices {...props} />}
        />
        <Route
          exact
          path="/management-nurse"
          component={props => <ManagementNurses {...props} />}
        />
        <Route
          exact
          path="/management-setting"
          component={props => <ManagementSetting {...props} />}
        />
      </Switch>
    </Router>
  );
